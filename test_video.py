...
class SampleVideo(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print('Reading video: {}'.format(self.path))
...
if __name__ == '__main__':
    ...
    for i, e in enumerate(events):
        ...
        cv2.putText(img,'{:.3f}'.format(confidence[i]),(20, 30),cv2.FONT_HERSHEY_DUPLEX,font_scale,(0, 255, 0),2)
        cv2.putText(img,event_names[i],(20, 60),cv2.FONT_HERSHEY_DUPLEX,font_scale,(0, 255, 0),2)    
